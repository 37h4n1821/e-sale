...
def extraerdatos(pagina):
    ...
    url=SERVIDOR+"/set.php?ID="+ID+"&Marca="+Marca+"&Nombre="+Nombre+"&Precio="+PRECIO+"&Precio2="+PRECIO2+"&Precio3="+PRECIO3+"&Descripcion="+DESCRIPCION+"&Categoria="+CATEGORIA+"&Url="+pagina+"&Tienda=Falabella"
